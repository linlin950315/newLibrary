...
import com.example.library.constant.AutoFillConstant;
import com.example.library.context.BaseContext;
import com.example.library.enumeration.OperationType;

import lombok.extern.slf4j.Slf4j;

//自定义切面 实现公共字段自动填充 Book insert用的这个。TODO 表设计上，时间的字段设置自动填充
@Aspect
...
public class AutoFillAspect {
    ...
    // 定义切入点 哪些类的哪些方法
    @Pointcut("execution(* com.example.library.mapper.*.*(..))&& @annotation(com.example.library.annotation.AutoFill)") // mapper下所有的类和方法
